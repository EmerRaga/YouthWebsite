window.openPanel = function(member) {
  ...
  if (member === "panel7") {
    ...
    text.innerHTML = `
      ...
      <p class="panel-role">Media Editor</p>
      <p>
        Rayhan is a 17 year old canadian student. She enjoys creating connections between her and her peers, and also introducing people to one another. Other than that, Rayhan enjoys playing games and watching anime. Her creativity is without a doubt her strength.
      </p>
      <p>
